...
public class CollisionDataCollection extends RoboticsAPIApplication {
    @Inject
...
//        impedanceControlmode.parametrize(CartDOF.ROT).setStiffness(0.2);
        ...
        impedanceControlmode.parametrize(CartDOF.B).setStiffness(1.0);
        impedanceControlmode.parametrize(CartDOF.C).setStiffness(1.0);
    ...
    private DataRecorder initDataRecorder() {
        ...
        final String fname = String.format("AN_Oct18_%s.log", timestamp);
