...
public class RCC_mounted_data_collection extends RoboticsAPIApplication {
    @Inject
...
//        impedanceControlmode.parametrize(CartDOF.ROT).setStiffness(0.2);
    ...
    private DataRecorder initDataRecorder() {
        ...
        final String fname = String.format("RCC_mounted_data_%s.log", timestamp);

        final long timeout = 900;  // 15 minutes
